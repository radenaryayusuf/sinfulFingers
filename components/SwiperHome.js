    ...
    return (
      ...
      >
        {pages.map((page, i) => (
          ...
          <Container style={[styles.fullScreen, styles.slide]} key={i}>
            {page}
          </Container>
        ))}
      </ScrollView>
...
//   };
  ...
  render = ({ children } = this.props) => {
    return    <View style={[styles.container, styles.fullScreen]}> {/* Render Continue or Done button */} {/*{this.renderButton()} */}   {/* Render screens */}  {this.renderScrollView(children)}    </View>
...
AppRegistry.registerComponent("SwiperHome", () => SwiperHome);
export default withNavigation(SwiperHome);